...
vector<Node *> unionBionomialHeap(vector<Node *> l1,
                                vector<Node *> l2)
{
    // _new to another binomial heap which contain
    // new heap after merging l1 & l2
    vector<Node *> _new;
    vector<Node *>::iterator it = l1.begin();
    vector<Node *>::iterator ot = l2.begin();
...
vector<Node *> insertATreeInHeap(vector<Node *> _heap,
                               Node *tree)
{
...
vector<Node *> removeMinFromTreeReturnBHeap(Node *tree)
{
    vector<Node *> heap;
...
vector<Node *> insert(vector<Node *> _head, int key)
{
