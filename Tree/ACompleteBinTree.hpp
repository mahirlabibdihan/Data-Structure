...
// heap class
template <typename E>
class ACompleteBinTree : public ABinTree<E>
{
...
public:
    ...
    ACompleteBinTree(E *t, int num, int max) : ABinTree<E>::ABinTree(t, num, max) // Constructor
    {
    }
    int height() const
    {
...
template <typename E>
// Preorder print
void ACompleteBinTree<E>::printhelp(int pos) const
{
...
template <typename E>
int ACompleteBinTree<E>::postorderhelp(int pos, E *arr, int idx) const
{
    if (pos >= this->n)
        return idx;
...
template <typename E>
int ACompleteBinTree<E>::preorderhelp(int pos, E *arr, int idx) const
{
    if (pos >= this->n)
        return idx;
    arr[idx++] = this->tree[pos];
...
template <typename E>
int ACompleteBinTree<E>::inorderhelp(int pos, E *arr, int idx) const
{
    if (pos >= this->n)
        return idx;
    if (this->left(pos) < this->n) // To avoid extra call
